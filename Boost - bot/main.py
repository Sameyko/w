...
`/clearstock` - Will delete everything from your stock""")
    embed.set_thumbnail(url="https://images-ext-1.discordapp.net/external/3X5P4asMUMEJv7YCpM2n3CIBnGtp4Px7QqhWJTKHZ6Y/https/images-ext-2.discordapp.net/external/X86taGw6u9-KRZUId6YkgFY_ECJckSWCtUj2o3qsJHQ/%253Fsize%253D1024/https/cdn.discordapp.com/icons/1066047911269515364/a_f0974dd9ba07624dfa185ddd00731574.gif?width=480&height=480")
...
async def restock(interaction: discord.Interaction, code: str, type: int):  # Change the type to int
    ...
    embed = discord.Embed(title=f"✅ | **TOKENS RESTOCK**",
                          ...
                          color=0x2F3136)
    embed.set_thumbnail(
        url="https://images-ext-1.discordapp.net/external/3X5P4asMUMEJv7YCpM2n3CIBnGtp4Px7QqhWJTKHZ6Y/https/images-ext-2.discordapp.net/external/X86taGw6u9-KRZUId6YkgFY_ECJckSWCtUj2o3qsJHQ/%253Fsize%253D1024/https/cdn.discordapp.com/icons/1066047911269515364/a_f0974dd9ba07624dfa185ddd00731574.gif?width=480&height=480")
    await interaction.response.send_message(embed=embed)
